                    ...
                    <div id="main">
                        <main id="content">
                            <div class="card p-4 shadow-lg rounded-4" style="max-width: 1000px; margin: 0 auto;">
                                <h4 class="text-center mb-4">Edit Invoice ${invoice.invoiceID}</h4>
                                <form action="editinvoice" method="post">
                                    <div class="form-group mb-3">
                                        <label>Invoice Code</label>
                                        <input value="${invoice.invoiceID}" type="text" class="form-control" id="invoiceId" name="invoiceId" readonly>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Apartment</label>
                                        <input value="${invoice.apartment.apartmentName}" type="text" class="form-control" id="apartment" name="apartment" readonly>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="description">Description</label>
                                        <input value="${invoice.description}" type="text" class="form-control" id="description" name="description" required>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="dueDate" name="dueDate" value="${invoice.dueDate}">
                                    </div>
                                    ...
                                    <table class="table table-bordered mt-3">
                                        ...
                                        <tbody id="invoiceDetailsTable">
                                            <c:forEach items="${invoice.details}" var="de" varStatus="loop">
                                                <tr>
                                                    <td>${loop.index + 1}</td>
                                                    <td><input type="text" class="form-control" name="descriptionde" value="${de.description}" required><c:if test="${not empty error}">
                                                            <div class="alert alert-danger" role="alert">
                                                                ${error}
                                                            </div>
                                                        </c:if></td>
                                                    <td><input type="number" class="form-control" name="amount" value="${de.amount}" required><c:if test="${not empty amountError}">
                                                            <div class="alert alert-danger" role="alert">
                                                                ${amountError}
                                                            </div>
                                                        </c:if></td>
