<%-- Document : addnews.jsp Created on : Feb 10, 2025, 9:25:09 AM Author : nkiem --%>
                        ...
                        <div class="container mt-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8 col-md-10">
                                    <form id="Create" action="addnews" method="POST"
                                        class="p-4 border rounded shadow bg-white" enctype="multipart/form-data">
