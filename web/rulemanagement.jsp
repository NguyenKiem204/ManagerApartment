                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="#editRuleModal" 
                                   ...
                                   data-toggle="modal"
                                   onclick='<c:set var = "selectedRule" scope = "page" value = ""></c:set>'>
                                       <i class="material-icons">&#xE147;</i> <span>Add New Rule</span>
                                   </a>
                                   <a href="#deleteRuleModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach var="rule" items="${rulesList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#editRuleModal"
                                           onclick="setEditRule('${rule.ruleName}', '${rule.ruleDescription}', '${rule.publicDate}')"
                                           class="edit" 
                                           data-toggle="modal">
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" required>${editRule.ruleDescription}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Public Date</label>
                                <input type="date" 
                                       class="form-control"
                                       value="${editRule.publicDate}"
                                       required>
                            </div>
