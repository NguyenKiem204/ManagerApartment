 ...
 * @author admin
 */
@WebServlet(name="AssetDetailServlet", urlPatterns={"/manager/assetdetail"})
public class AssetDetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AssetDetailServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AssetDetailServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("assetdetail.jsp").forward(request, response);
    } 
