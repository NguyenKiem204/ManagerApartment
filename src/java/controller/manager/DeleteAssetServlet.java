 ...
 * @author admin
 */
@WebServlet(name="DeleteAssetServlet", urlPatterns={"/manager/deleteasset"})
public class DeleteAssetServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            ApartmentAssets aa = apartmentAssetsDAO.selectById(assetId);
            apartmentAssetsDAO.delete(aa);
